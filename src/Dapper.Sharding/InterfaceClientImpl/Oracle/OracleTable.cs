...
namespace Dapper.Sharding
{
    ...
    internal partial class OracleTable<T> : ITable<T> where T : class
    {
        ...
        public override IEnumerable<T> GetByIdsForUpdate(object ids, string returnFields = null)
        {
            ...
            var dpar = new DynamicParameters();
            dpar.Add(":ids", ids);
            return DataBase.Query<T>($"SELECT {returnFields} FROM {Name} WHERE {SqlField.PrimaryKey} IN :ids FOR UPDATE", dpar);
        }
        ...
        public override T GetByWhereFirst(string where, object param = null, string returnFields = null)
        {
            ...
            return DataBase.QueryFirstOrDefault<T>($"SELECT {returnFields} FROM {Name} {where}", param);
        }
    ...
    internal partial class OracleTable<T> : ITable<T> where T : class
    {
        ...
        public override IEnumerable<dynamic> GetByIdsForUpdateDynamic(object ids, string returnFields = null)
        {
            ...
            var dpar = new DynamicParameters();
            dpar.Add(":ids", ids);
            return DataBase.Query($"SELECT {returnFields} FROM {Name} WHERE {SqlField.PrimaryKey} IN :ids FOR UPDATE", dpar);
        }
        ...
        public override dynamic GetByWhereFirstDynamic(string where, object param = null, string returnFields = null)
        {
            ...
            return DataBase.QueryFirstOrDefault($"SELECT {returnFields} FROM {Name} {where}", param);
        }
