...
namespace Test
{
    public class Factory
    {
        ...
        /*===postgresql===*/
        //public static IClient Client = ShardingFactory.CreateClient(DataBaseType.Postgresql, new DataBaseConfig { Server = "127.0.0.1", UserId = "postgres", Password = "123", MaxPoolSize = 1 });
